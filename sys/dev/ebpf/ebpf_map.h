...
void *ebpf_map_lookup_elem(struct ebpf_vm_state *, struct ebpf_map *map,
    void *key);
void *ebpf_map_path_lookup(struct ebpf_vm_state *, struct ebpf_map *map,
    void **key);
int ebpf_map_update_elem(struct ebpf_vm_state *, struct ebpf_map *map,
    void *key, void *value, uint64_t flags);
int ebpf_map_delete_elem(struct ebpf_vm_state *, struct ebpf_map *map, void *key);
